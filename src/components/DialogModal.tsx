function DialogModal(props: any) {
    return ( 
        <div onClick={() => props.setDialogModalOpen(false)} ref={props.modalRef} className={`${props.open ? 'block' : 'hidden'}  transition-opacity opacity-1 z-[8000] w-full h-full fixed flex flex-col place-items-center pointer-events-auto
